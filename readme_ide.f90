...
IDEcamb is a CAMB and CosmoMC patch for interacting dark energy (IDE) theory. 
Current vertion is based on the CosmoMC-planck2018 package, which can be download from 
https://github.com/cmbant/CosmoMC/tree/planck2018

install: 
Copy the patch into the CosmoMC-planck2018 package and cover the same files.
make or make all

run: 
Modify test_ide.ini with your data, params and other settings, then run ./cosmomc test_ide.ini
